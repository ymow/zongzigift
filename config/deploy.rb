...
role :web, "xo6.com"                          # Your HTTP server, Apache/etc
role :app, "xo6.com"                         # This may be the same as your `Web` server
role :db,  "xo6.com"   , :primary => true # This is where Rails migrations will run
